...
API v1 may introduce `upstreams`, `retainResult`, `openai_image`, `usageProfiles`, `unitLabel`, `requiredCapabilities`, or SSE capabilities. Older hosts will reject unsupported fields and capabilities, even if the version number is also 1.
