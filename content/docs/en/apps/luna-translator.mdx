...
description: LunaTranslator setup guide — open-source GalGame and visual novel translator with HOOK, OCR, and AI-powered translation. Integrate with __brandName__ for enhanced accuracy.
---
