...
description: AionUi setup guide — free, open-source desktop office agent supporting Gemini CLI, Claude Code, Codex, and more. Connect to __brandName__ for multi-model AI workflows.
---
